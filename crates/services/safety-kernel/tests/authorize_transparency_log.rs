//! internal-ref Phase 3 Step 5 — kernel-side transparency-log fail-CLOSED
//! integration tests.
//!
...
enum MockBehavior {
    ...
    Conflict,
    SlowSleep(Duration),
    /// internal-ref: trait-level surface for the new `ProtocolViolation`
...
/// internal-ref / Phase 3 Step 8 — when the t-log returns a 2xx with a
