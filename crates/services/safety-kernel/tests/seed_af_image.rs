//! AF-image seed fixture — internal-ref release-gate adversarial taxonomy.
//!
...
//! attestation chain) ship across multiple internal-ref / internal-ref sub-
...
//! gives internal-ref / 1887 a concrete file to extend when the richer
//! defences land.
//!
...
/// registry-pin verification (internal-ref + internal-ref follow-up). The lint
