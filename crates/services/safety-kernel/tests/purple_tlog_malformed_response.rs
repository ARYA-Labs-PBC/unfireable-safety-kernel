//! internal-ref Phase 3 — Purple-Team adversarial tests for the kernel
...
//!        internal-ref). RESOLUTION (Phase 3 Step 8): the wire client
...
// ---------------------------------------------------------------------------
// C2 — Defense-gap CLOSED (internal-ref, Phase 3 Step 8): the wire client
...
async fn purple_c2_trait_mock_does_not_exercise_wire_cross_check_snapshot() {
    ...
    // through the wire path that performs the internal-ref cross-check, so
