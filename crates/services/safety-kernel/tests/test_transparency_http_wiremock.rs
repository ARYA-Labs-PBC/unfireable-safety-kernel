//! internal-ref Phase 3 /test wave — real HTTP wiremock test for
...
/// internal-ref: the kernel cross-verifies the t-log's `leaf_hash_hex`
...
async fn http_201_fresh_insert_returns_ok() {
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(ResponseTemplate::new(201).set_body_json(serde_json::json!({
            ...
            // internal-ref: must match the kernel's locally-computed
...
/// internal-ref / Phase 3 Step 8 — t-log returns a 2xx with a
...
/// internal-ref / Phase 3 Step 8 — non-hex `leaf_hash_hex` MUST also map
