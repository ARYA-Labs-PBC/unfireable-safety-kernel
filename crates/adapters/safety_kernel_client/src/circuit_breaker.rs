...
//! permissive.
//!
//! internal-ref Phase 2a Step 5 — audit hardening against ADR §6:
...
// internal-ref Phase 2a Step 2 — KernelError replaced by KernelClientError;
...
mod tests {
    ...
    fn open_breaker_returns_unavailable_within_cooldown_window() {
        // internal-ref AC2 (R): FAIL-CLOSED. Open breaker MUST return
    ...
    // internal-ref Phase 2a Step 5 — ADR §6 audit tests.
