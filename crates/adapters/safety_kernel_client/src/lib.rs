// internal-ref Phase 2a Step 2: same scaffold-stage allows that the parent
...
//! Safety Kernel client adapter — internal-ref Phase 2a (internal-ref).
//!
//! Rust client SDK for the Safety Kernel HTTP service shipped by
//! internal-ref (crates/services/safety-kernel/). Per internal-ref
...
//! - `reqwest_client`  — Slice 2 DDI dispatcher SK client (internal-ref
