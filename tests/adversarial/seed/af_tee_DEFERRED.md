...
[internal-ref]((internal issue)) targets commodity hardware for v1.0. TEE / TDX / SEV-SNP attestation is documented in that issue's "Long-term roadmap" section but is **not** in scope for v1.0 acceptance criteria. The deployment surface that AF-tee would attack does not exist in the v1.0 build.
