"""gRPC server interceptor for the Safety Kernel (internal-ref 2c-python).
...
class StreamingNotAuthorizedError(RuntimeError):
    ...
    internal-ref: streaming RPCs cannot be safely gated by the current
        ...
        *,
        ...
        Args:
            ...
            allow_streaming: When False (default, recommended), the
                ...
                is the pre-internal-ref behaviour).
        """
