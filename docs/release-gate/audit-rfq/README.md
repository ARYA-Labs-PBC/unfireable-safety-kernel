...
Three RFQ drafts for the [internal-ref]((internal issue)) v1.0 release-gate external audit (AC3–AC4).
...
- [ ] The Q3 2026 calendar is still realistic against the burn-in start (internal-ref, AC5).
